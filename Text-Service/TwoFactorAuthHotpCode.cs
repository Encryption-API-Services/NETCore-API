...
namespace Text_Service
{
    public class TwoFactorAuthHotpCode
    {
        ...
        {
            IHotpCodesRepository hotpCodesRepository = new HotpCodesRepository(this._databaseSettings);
            IUserRepository userRepository = new UserRepository(this._databaseSettings);
